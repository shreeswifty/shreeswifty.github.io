...
var Node=Class.extend({
 ...
 var w=this.centrality*35;_ctx_graph_fillStyle("rgba(0,0,0,0.1)",ctx);ctx.beginPath();ctx.arc(this.x,this.y,this.radius+w,0,Math.PI*2,true);ctx.closePath();ctx.fill();}
